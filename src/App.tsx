...
                        </button>
                        <br />
                        <button
                            onClick={() => window.open('https://kartkowkafunc-etaeawfubqcefcah.westeurope-01.azurewebsites.net/api/getStudentData?code=LQuinjcOfNMJdFGdLZlM-4uPL5aRHG6OupsYhQKtAtbiAzFutX9Lag==&username=rewak.w@wp.pl', '_blank')}
                            className="bg-blue-500 hover:bg-blue-600 text-white text-sm font-bold py-1 px-4 rounded-lg shadow-md transition duration-200 mt-2"
                        >
